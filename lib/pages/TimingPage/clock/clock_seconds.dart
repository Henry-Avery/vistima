...
class ClockSecondsPainter extends CustomPainter {
  ...
  ClockSecondsPainter(
      {@required this.accentColor, this.dateTime, this.isTiming = false, this.seconds});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Outer indicator.
    if (isTiming) {
      var customTimeAngle = (seconds - 1) * (2 * pi / 60) + msecs - secSize / 2;
      canvas.drawArc(
          outerRect, -pi / 2, customTimeAngle + secSize, false, paint);
    } else {
